 ...
 <p>Currently working at Tekkon Tech</p>
  ...
  return (
    <>
        ...
        <h2 className='heading'><span>Meet</span> our Team </h2>

            <Popover content={dipeshcontent} title= { <h3>Dipesh Mishra</h3> } >
                  <div className="profiles">
                  <div className="profile">
                  <img className='profile-img' src={dipesh} height={40} width={40} /> <br /> <strong>Founder </strong>
                  </div>
                  </div>
                </Popover>  <br /> 
                <div className="container">
                  <div className="profiles">
                    ...
                    <div className="profile">
                      <img src={bhanu} alt="BhanuBhakta Bista" className='profile-img' />
                    ...
                    <div className="profile">
                      <img src={manish} alt="Manish Kumar Yadav" className='profile-img' />
                      <h3 className='user-name'>Manish Kumar Yadav</h3>
                      <h5>Developer</h5>
                      <p>Currently working at Yarti Technologies</p>
                    </div>
                    <div className="profile">
                      <img src={bidhya} alt="Bidhyanand Poddar" className='profile-img' />
