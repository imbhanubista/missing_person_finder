...
//   function to handle login button
  ...
  const onFinish = async(values) => {
      setLoading(true)
    let signupData = await axios.post("https://ymissing.herokuapp.com/api/auth/register",
    values
    )
      ...
      >
       ...
       <Space direction="vertical">
         ...
         <Input.Password
          ...
          {/* Sign Up button */}
          <Button loading={loading} htmlType="submit" type="primary" className="login-form-button">Sign Up</Button>
          Already a user?{" "}
